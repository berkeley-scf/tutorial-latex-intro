...
% You might look at www.latex-tutorial.com for tutorial info. A bit of Googling should also point you to a variety of resources. 

% you can create a pdf from this document by doing the following at the UNIX command line (this should work in the VM):
% pdflatex demo
% make sure you leave off the .tex extension when invoking pdflatex
