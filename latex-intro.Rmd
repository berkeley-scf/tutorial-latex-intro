...
TeXShop (for Mac) and MiKTeX (for Windows) provide installations of LaTeX that include the ability to easily create a PDF and see the PDF alongside the source LaTeX file. You should be able to see how to create a PDF using the pull-down menus.
